...
|---------|-------------|-----------|----------|--------------|-------------------|--------------------|----------------|-------------|-----------|--------------------|---------------------------|----------------------------|----------|-----------|--------|
| 2023-08-31 | 1,359,765 | 1,363,361 |  | 2 | 2 |  |  | 1,112 | 7,216 |   |   |   |  |  |  |
| 2023-08-30 | 1,356,167 | 1,359,764 |  |  |  |  |  | 1,112 | 7,198 |   |   |   |  |  |  |
| 2023-08-29 | 1,352,569 | 1,356,166 |  | 2 | 2 |  |  | 1,112 | 7,204 |   |   |   |  |  |  |
| 2023-08-28 | 1,352,004 | 1,352,568 |  | 1 | 1 |  |  | 1,112 | 1,137 |   |   |   |  |  | 565 missing (100.18%) |
...
SELECT date(origination_ts) as logDT, 
 ...
 where destination_para_id = 2102 and LAST_DAY(date(origination_ts)) = "2023-08-31" 
...
SELECT date(origination_ts) as logDT, 
 ...
 FROM `bigquery-public-data.crypto_kusama.xcmtransfers` 
 where origination_para_id = 2102 and LAST_DAY(date(origination_ts)) = "2023-08-31" 
 group by logDT 
order by logDT
```
