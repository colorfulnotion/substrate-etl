...
|---------|-------------|-----------|----------|--------------|-------------------|--------------------|----------------|-------------|-----------|--------------------|---------------------------|----------------------------|----------|-----------|--------|
| 2023-12-05 |  |  |  |  |  |  |  |  |  |   | 35 ($23,757.97) |   | 61 | 50 |  |
| 2023-12-04 |  |  |  |  |  |  |  |  |  |   | 16 ($1,069.62) |   | 31 | 39 |  |
...
SELECT date(origination_ts) as logDT, 
 ...
 where destination_para_id = 2110 and LAST_DAY(date(origination_ts)) = "2023-12-31" 
...
SELECT date(origination_ts) as logDT, 
 ...
 FROM `bigquery-public-data.crypto_kusama.xcmtransfers` 
 where origination_para_id = 2110 and LAST_DAY(date(origination_ts)) = "2023-12-31" 
 group by logDT 
order by logDT
```
