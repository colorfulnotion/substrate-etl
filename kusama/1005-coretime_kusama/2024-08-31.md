...
|---------|-------------|-----------|----------|--------------|-------------------|--------------------|----------------|-------------|-----------|--------------------|---------------------------|----------------------------|----------|-----------|--------|
| 2024-08-05 | 815,713 | 822,740 | 7,028 | 4 |  |  |  | 47 | 14,361 | 104  |   |   |  |  |  |
| 2024-08-04 | 808,671 | 815,712 | 7,042 |  |  |  |  | 47 | 14,265 |   |   |   |  |  |  |
| 2024-08-03 | 801,629 | 808,670 | 7,042 |  |  |  |  | 47 | 14,265 |   |   |   |  |  |  |
| 2024-08-02 | 794,564 | 801,628 | 7,065 | 8 |  |  |  | 47 | 14,515 | 143  |   |   |  |  |  |
| 2024-08-01 | 787,524 | 794,563 | 7,040 | 17 |  |  |  | 46 | 14,703 | 292  |   |   |  |  |  |
...
SELECT date(origination_ts) as logDT, 
 ...
 where destination_para_id = 1005 and LAST_DAY(date(origination_ts)) = "2024-08-31" 
...
SELECT date(origination_ts) as logDT, 
 ...
 FROM `bigquery-public-data.crypto_kusama.xcmtransfers` 
 where origination_para_id = 1005 and LAST_DAY(date(origination_ts)) = "2024-08-31" 
 group by logDT 
order by logDT
```
