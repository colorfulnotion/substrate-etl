...
|---------|-------------|-----------|----------|--------------|-------------------|--------------------|----------------|-------------|-----------|--------------------|---------------------------|----------------------------|----------|-----------|--------|
| 2023-09-01 | 1,834,618 | 1,835,448 | 831 |  | 2 |  |  | 1,363 | 32,000 |   |   |   |  |  |  |
...
SELECT date(origination_ts) as logDT, 
 ...
 where destination_para_id = 2123 and LAST_DAY(date(origination_ts)) = "2023-09-30" 
...
SELECT date(origination_ts) as logDT, 
 ...
 FROM `bigquery-public-data.crypto_kusama.xcmtransfers` 
 where origination_para_id = 2123 and LAST_DAY(date(origination_ts)) = "2023-09-30" 
 group by logDT 
order by logDT
```
