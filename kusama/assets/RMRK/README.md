...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [Statemine](/kusama/1000-statemine) | 6,138 | 9,999,611.77 $27,177,828.56 |   |    |   | $2.72 | `{"Token":"8"}` |
| [Moonriver](/kusama/2023-moonriver) | 3,263 | 4,625,920.97 $12,572,736.80 |   |    |   | $2.72 | `{"Token":"182365888117048807484804376330534607370"}` |
| [Karura](/kusama/2000-karura) | 894 | 138,546.03 $376,552.66 |   |    |   | $2.72 | `{"ForeignAsset":"0"}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "RMRK" and date(ts) = "2023-02-26"
 group by para_id
