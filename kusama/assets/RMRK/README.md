...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [Statemine](/kusama/1000-statemine) | 6,128 | 9,999,611.77 $27,177,828.56 |   |    |   | $2.72 | `{"Token":"8"}` |
| [Moonriver](/kusama/2023-moonriver) | 3,265 | 4,625,900.69 $12,572,681.70 |   |    |   | $2.72 | `{"Token":"182365888117048807484804376330534607370"}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "RMRK" and date(ts) = "2023-02-22"
 group by para_id
