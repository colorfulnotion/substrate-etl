...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [Pichiu](/kusama/2102-pichiu) | 1,144 | 99,999,989.99  | 10  | 7,207,822.34   |   |  | `{"Token":"PCHU"}` |
| [Karura](/kusama/2000-karura) | 14 | 22,212.11  |   |    |   |  | `{"ForeignAsset":"17"}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "PCHU" and date(ts) = "2023-03-16"
 group by para_id
