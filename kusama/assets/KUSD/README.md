...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [Karura](/kusama/2000-karura) | 3,410 | 3,616,004.75 $3,616,004.75 |   |    |   | $1.00 | `{"Token":"KUSD"}` |
| [Moonriver](/kusama/2023-moonriver) | 70 | 58,463.39 $58,463.39 |   |    |   | $1.00 | `{"Token":"214920334981412447805621250067209749032"}` |
| [Basilisk](/kusama/2090-basilisk) | 188 | 6,092.61 $6,092.61 |   |    |   | $1.00 | `{"Token":"2"}` |
...
| [Bifrost-Kusama](/kusama/2001-bifrost-ksm) | 1,609 | 75,516.1  |   |    |   |  | `{"Stable":"KUSD"}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "KUSD" and date(ts) = "2023-03-02"
 group by para_id
