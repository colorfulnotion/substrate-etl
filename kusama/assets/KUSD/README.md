...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [Karura](/kusama/2000-karura) | 3,412 | 3,577,894.27 $3,577,894.27 |   |    |   | $1.00 | `{"Token":"KUSD"}` |
| [Moonriver](/kusama/2023-moonriver) | 71 | 58,548.96 $58,548.96 |   |    |   | $1.00 | `{"Token":"214920334981412447805621250067209749032"}` |
| [Basilisk](/kusama/2090-basilisk) | 188 | 6,072.74 $6,072.74 |   |    |   | $1.00 | `{"Token":"2"}` |
...
| [Bifrost-Kusama](/kusama/2001-bifrost-ksm) | 1,608 | 73,362.45  |   |    |   |  | `{"Stable":"KUSD"}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "KUSD" and date(ts) = "2023-03-08"
 group by para_id
