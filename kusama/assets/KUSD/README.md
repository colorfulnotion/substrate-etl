...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [Karura](/kusama/2000-karura) | 3,409 | 3,592,524.65 $3,592,524.65 |   |    |   | $1.00 | `{"Token":"KUSD"}` |
| [Moonriver](/kusama/2023-moonriver) | 70 | 58,094.04 $58,094.04 |   |    |   | $1.00 | `{"Token":"214920334981412447805621250067209749032"}` |
| [Basilisk](/kusama/2090-basilisk) | 189 | 6,125.52 $6,125.52 |   |    |   | $1.00 | `{"Token":"2"}` |
...
| [Bit.Country Pioneer](/kusama/2096-bitcountrypioneer) | 3 | 0.2 $0.20 |   |    |   | $1.00 | `{"Stable":"0"}` |
| [Bifrost-Kusama](/kusama/2001-bifrost-ksm) | 1,608 | 73,820.67  |   |    |   |  | `{"Stable":"KUSD"}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "KUSD" and date(ts) = "2023-03-04"
 group by para_id
