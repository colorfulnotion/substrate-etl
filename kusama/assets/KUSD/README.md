...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [Karura](/kusama/2000-karura) | 3,412 | 3,575,543.72 $3,575,543.72 |   |    |   | $1.00 | `{"Token":"KUSD"}` |
| [Moonriver](/kusama/2023-moonriver) | 70 | 57,917.32 $57,917.32 |   |    |   | $1.00 | `{"Token":"214920334981412447805621250067209749032"}` |
| [Basilisk](/kusama/2090-basilisk) | 187 | 6,119.32 $6,119.32 |   |    |   | $1.00 | `{"Token":"2"}` |
...
| [Bifrost-Kusama](/kusama/2001-bifrost-ksm) | 1,609 | 73,405.69  |   |    |   |  | `{"Stable":"KUSD"}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "KUSD" and date(ts) = "2023-03-07"
 group by para_id
