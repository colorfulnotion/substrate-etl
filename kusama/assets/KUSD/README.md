...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [Karura](/kusama/2000-karura) | 3,418 | 3,619,182.32 $3,619,182.32 |   |    |   | $1.00 | `{"Token":"KUSD"}` |
| [Moonriver](/kusama/2023-moonriver) | 70 | 58,142 $58,142.00 |   |    |   | $1.00 | `{"Token":"214920334981412447805621250067209749032"}` |
| [Basilisk](/kusama/2090-basilisk) | 185 | 6,101.48 $6,101.48 |   |    |   | $1.00 | `{"Token":"2"}` |
...
| [Bifrost-Kusama](/kusama/2001-bifrost-ksm) | 1,610 | 75,876.8  |   |    |   |  | `{"Stable":"KUSD"}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "KUSD" and date(ts) = "2023-02-27"
 group by para_id
