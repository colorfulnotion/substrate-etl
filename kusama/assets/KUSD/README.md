...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [Karura](/kusama/2000-karura) | 3,419 | 3,627,820.58 $3,627,820.58 |   |    |   | $1.00 | `{"Token":"KUSD"}` |
| [Moonriver](/kusama/2023-moonriver) | 70 | 58,551.92 $58,551.92 |   |    |   | $1.00 | `{"Token":"214920334981412447805621250067209749032"}` |
| [Basilisk](/kusama/2090-basilisk) | 186 | 6,177.49 $6,177.49 |   |    |   | $1.00 | `{"Token":"2"}` |
...
| [Bifrost-Kusama](/kusama/2001-bifrost-ksm) | 1,609 | 76,354.89  |   |    |   |  | `{"Stable":"KUSD"}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "KUSD" and date(ts) = "2023-02-26"
 group by para_id
