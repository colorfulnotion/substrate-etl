...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [Bifrost-Kusama](/kusama/2001-bifrost-ksm) | 36,782 | 56,613.41  | 6,210.89  |    |   |  | `{"VSToken":"KSM"}` |
| [Karura](/kusama/2000-karura) | 130 | 165.91  |   |    |   |  | `{"Token":"VSKSM"}` |
| [Mangatax](/kusama/2110-mangatax) | 55 | 852.17  |   |    |   |  | `{"Token":"16"}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "VSKSM" and date(ts) = "2023-03-11"
 group by para_id
