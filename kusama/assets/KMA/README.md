...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [Moonriver](/kusama/2023-moonriver) | 113 | 7,181,338.14 $15,251.69 |   |    |   | $0.00212 | `{"Token":"213357169630950964874127107356898319277"}` |
| [Karura](/kusama/2000-karura) | 9 | 42,746.23 $90.78 |   |    |   | $0.00212 | `{"ForeignAsset":"10"}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "KMA" and date(ts) = "2023-02-27"
 group by para_id
