...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [Moonriver](/kusama/2023-moonriver) | 113 | 6,582,866.46 $13,592.19 |   |    |   | $0.00206 | `{"Token":"213357169630950964874127107356898319277"}` |
| [Karura](/kusama/2000-karura) | 9 | 42,746.23 $88.26 |   |    |   | $0.00206 | `{"ForeignAsset":"10"}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "KMA" and date(ts) = "2023-03-15"
 group by para_id
