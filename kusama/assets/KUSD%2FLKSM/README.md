# KUSD/LKSM substrate-etl Summary
...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [Karura](/kusama/2000-karura) | 43 | 647,133.16 $284,852.89 |   |    |   | $0.44 | `[{"Token":"KUSD"},{"Token":"LKSM"}]` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "KUSD/LKSM" and date(ts) = "2023-02-24"
 group by para_id
