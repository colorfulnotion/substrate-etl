...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [Altair](/kusama/2088-altair) | 29,386 | 476,513,030.02 $4,336,658.21 | 511,304.05 $4,653.28 | 78,975,785.64  $718,744.23 | 13,527,150.49 $123,108.13 | $0.0091 | `{"Token":"AIR"}` |
| [Karura](/kusama/2000-karura) | 279 | 3,352,157.72 $30,507.38 |   |    |   | $0.0091 | `{"ForeignAsset":"12"}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "AIR" and date(ts) = "2023-03-07"
 group by para_id
