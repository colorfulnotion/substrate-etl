# KUSD/AIR substrate-etl Summary
...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [Karura](/kusama/2000-karura) | 17 | 6,793.33 $7,084.49 |   |    |   | $1.04 | `[{"Token":"KUSD"},{"ForeignAsset":"12"}]` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "KUSD/AIR" and date(ts) = "2023-02-22"
 group by para_id
