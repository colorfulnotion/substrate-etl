...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [Litmus](/kusama/2106-litmus) | 13,912 | 492,086.9 $533,534.17 | 0.77 $0.83 | 335,764.71  $364,045.35 |   | $1.08 | `{"Token":"LIT"}` |
| [Moonriver](/kusama/2023-moonriver) | 24 | 931.16 $992.97 |   |    |   | $1.07 | `{"Token":"65216491554813189869575508812319036608"}` |
| [Karura](/kusama/2000-karura) | 2 | 1 $1.07 |   |    |   | $1.07 | `{"ForeignAsset":"20"}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "LIT" and date(ts) = "2023-03-16"
 group by para_id
