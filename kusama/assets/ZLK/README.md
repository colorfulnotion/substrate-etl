...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [Bifrost-Kusama](/kusama/2001-bifrost-ksm) | 20,381 | 3,609,413.8 $108,722.58 |   |    |   | $0.03 | `{"Token":"ZLK"}` |
| [Khala](/kusama/2004-khala) | 6 | 73,826.56 $2,223.80 |   |    |   | $0.03 | `{"Token":"3"}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "ZLK" and date(ts) = "2023-02-27"
 group by para_id
