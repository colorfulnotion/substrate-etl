...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [Bifrost-Kusama](/kusama/2001-bifrost-ksm) | 20,380 | 3,609,413.8 $114,355.15 |   |    |   | $0.03 | `{"Token":"ZLK"}` |
| [Khala](/kusama/2004-khala) | 6 | 60,063.46 $1,902.96 |   |    |   | $0.03 | `{"Token":"3"}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "ZLK" and date(ts) = "2023-02-24"
 group by para_id
