...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [Bifrost-Kusama](/kusama/2001-bifrost-ksm) | 20,403 | 3,709,413.8 $102,000.32 |   |    |   | $0.03 | `{"Token":"ZLK"}` |
| [Khala](/kusama/2004-khala) | 6 | 277,298.23 $7,625.06 |   |    |   | $0.03 | `{"Token":"3"}` |
| [Mangatax](/kusama/2110-mangatax) | 52 | 87,045.22 $2,393.54 |   |    |   | $0.03 | `{"Token":"26"}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "ZLK" and date(ts) = "2023-03-09"
 group by para_id
