...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [Bifrost-Kusama](/kusama/2001-bifrost-ksm) | 20,387 | 3,609,413.8 $103,234.56 |   |    |   | $0.03 | `{"Token":"ZLK"}` |
| [Khala](/kusama/2004-khala) | 6 | 179,216.16 $5,125.85 |   |    |   | $0.03 | `{"Token":"3"}` |
| [Mangatax](/kusama/2110-mangatax) | 49 | 134,830.46 $3,856.35 |   |    |   | $0.03 | `{"Token":"26"}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "ZLK" and date(ts) = "2023-03-04"
 group by para_id
