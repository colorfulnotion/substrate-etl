...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [Picasso](/kusama/2087-picasso) | 2,643 | 9,999,999,976.7  | 23.3  | 756,621,216   | 751,577,006  |  | `{"Token":"PICA"}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "PICA" and date(ts) = "2023-02-23"
 group by para_id
