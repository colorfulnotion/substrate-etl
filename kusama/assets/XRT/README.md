...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [Robonomics](/kusama/2048-robonomics) | 3,151 | 994,883.38 $5,680,215.09 | 199.04 $1,136.40 | 144,530.92  $825,188.91 |   | $5.71 | `{"Token":"XRT"}` |
| [Moonriver](/kusama/2023-moonriver) | 42 | 97,224.4 $555,095.69 |   |    |   | $5.71 | `{"Token":"108036400430056508975016746969135344601"}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "XRT" and date(ts) = "2023-03-04"
 group by para_id
