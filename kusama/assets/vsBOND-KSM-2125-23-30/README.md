# vsBOND-KSM-2125-23-30 on kusama substrate-etl Summary
...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [Bifrost-Kusama](/kusama/2001-bifrost-ksm) | 91 | 1,549.25  |   |    |   |  | `{"VSBond":["KSM","2,125","23","30"]}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "vsBOND-KSM-2125-23-30" and date(ts) = "2023-03-06"
 group by para_id
