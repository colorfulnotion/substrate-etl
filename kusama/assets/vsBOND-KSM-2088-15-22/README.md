# vsBOND-KSM-2088-15-22 substrate-etl Summary
...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [Bifrost-Kusama](/kusama/2001-bifrost-ksm) | 347 | 2,181.05  | 1,490.39  |    |   |  | `{"VSBond":["KSM","2,088","15","22"]}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "vsBOND-KSM-2088-15-22" and date(ts) = "2023-02-24"
 group by para_id
