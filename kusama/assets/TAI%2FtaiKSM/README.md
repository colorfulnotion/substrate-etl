# TAI/taiKSM substrate-etl Summary
...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [Karura](/kusama/2000-karura) | 335 | 553,615.25  |   |    |   |  | `[{"Token":"TAI"},{"StableAssetPoolToken":"0"}]` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "TAI/taiKSM" and date(ts) = "2023-02-24"
 group by para_id
