...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [InvArch Tinkernet](/kusama/2125-tinkernet) | 7,762 | 11,669,920.5  | 30,075  | 1,984,438.54   | 1,984,438.54  |  | `{"Token":"TNKR"}` |
| [Basilisk](/kusama/2090-basilisk) | 1,675 | 1,015,785.36  |   |    |   |  | `{"Token":"6"}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "TNKR" and date(ts) = "2023-03-18"
 group by para_id
