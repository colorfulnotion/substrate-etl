...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [InvArch Tinkernet](/kusama/2125-tinkernet) | 7,764 | 11,669,925.53  | 30,070  | 1,998,460.65   | 1,998,460.65  |  | `{"Token":"TNKR"}` |
| [Basilisk](/kusama/2090-basilisk) | 1,665 | 997,411.07  |   |    |   |  | `{"Token":"6"}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "TNKR" and date(ts) = "2023-03-15"
 group by para_id
