...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [InvArch Tinkernet](/kusama/2125-tinkernet) | 7,762 | 11,684,930.68  | 15,065  | 2,012,215.69   | 2,012,215.69  |  | `{"Token":"TNKR"}` |
| [Basilisk](/kusama/2090-basilisk) | 1,647 | 805,967.35  |   |    |   |  | `{"Token":"6"}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "TNKR" and date(ts) = "2023-03-06"
 group by para_id
