# vsBOND-KSM-2256-27-34 substrate-etl Summary
...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [Bifrost-Kusama](/kusama/2001-bifrost-ksm) | 84 | 3,510.11  |   |    |   |  | `{"VSBond":["KSM","2,256","27","34"]}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "vsBOND-KSM-2256-27-34" and date(ts) = "2023-02-24"
 group by para_id
