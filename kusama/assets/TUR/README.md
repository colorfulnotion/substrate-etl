...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [Turing](/kusama/2114-turing) | 7,585 | 425,794,011.65  | 494.74  | 33,220,436.84   | 33,217,784.84  |  | `{"Token":"TUR"}` |
| [Mangatax](/kusama/2110-mangatax) | 546 | 5,421,555.29  |   |    |   |  | `{"Token":"7"}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "TUR" and date(ts) = "2023-03-08"
 group by para_id
