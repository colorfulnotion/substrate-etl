...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [Bit.Country Pioneer](/kusama/2096-bitcountrypioneer) | 24,780 | 94,433,090.24 $17,184,491.40 | 5,566,821.19 $1,013,024.04 | 73,603,367.08  $13,393,995.95 |   | $0.18 | `{"Token":"NEER"}` |
| [Karura](/kusama/2000-karura) | 13 | 11.49 $2.09 |   |    |   | $0.18 | `{"ForeignAsset":"9"}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "NEER" and date(ts) = "2023-03-16"
 group by para_id
