...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [Bit.Country Pioneer](/kusama/2096-bitcountrypioneer) | 24,872 | 94,467,688.33 $21,265,151.64 | 5,532,224.79 $1,245,331.62 | 73,648,613.25  $16,578,673.16 |   | $0.23 | `{"Token":"NEER"}` |
| [Karura](/kusama/2000-karura) | 13 | 11.29 $2.54 |   |    |   | $0.23 | `{"ForeignAsset":"9"}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "NEER" and date(ts) = "2023-02-28"
 group by para_id
