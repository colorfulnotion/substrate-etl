...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [Darwinia Crab](/kusama/2105-crab) | 5,021 | 1,356,240,940.47 $1,352,453.61 | 32,881.23 $32.79 | 2,002,201.95  $1,996.61 | 2,002,201.95 $1,996.61 | - | `{"Token":"CRAB"}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "CRAB" and date(ts) = "2023-03-10"
 group by para_id
