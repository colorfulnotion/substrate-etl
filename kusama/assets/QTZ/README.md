...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [Quartz](/kusama/2095-quartz) | 91,328 | 1,097,032,975.32 $1,381,210.83 |   | 732,759,055.22  $922,574.59 | 732,759,055.22 $922,574.59 | $0.00126 | `{"Token":"QTZ"}` |
| [Karura](/kusama/2000-karura) | 308 | 5,510,398.92 $6,937.82 |   |    |   | $0.00126 | `{"ForeignAsset":"2"}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "QTZ" and date(ts) = "2023-03-03"
 group by para_id
