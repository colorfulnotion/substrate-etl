...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [Crust Shadow](/kusama/2012-shadow) | 3,202 | 199,998,811.17 $3,057,377.04 | 1,168.93 $17.87 | 1,048,894.86  $16,034.43 | 412,959.96 $6,312.91 | $0.02 | `{"Token":"CSM"}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "CSM" and date(ts) = "2023-02-22"
 group by para_id
