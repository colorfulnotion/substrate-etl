# FAN on kusama substrate-etl Summary
...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [Statemine](/kusama/1000-statemine) | 4 | 6,942,000,694,270,425,000,000,000  |   |    |   |  | `{"Token":"46"}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "FAN" and date(ts) = "2023-03-09"
 group by para_id
