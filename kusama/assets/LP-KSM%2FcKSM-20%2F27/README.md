# LP-KSM/cKSM-20/27 substrate-etl Summary
...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [Parallel Heiko](/kusama/2085-parallel-heiko) | 13 | 7.08 $600.01 |   |    |   | $84.80 | `{"Token":"5004"}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "LP-KSM/cKSM-20/27" and date(ts) = "2023-02-22"
 group by para_id
