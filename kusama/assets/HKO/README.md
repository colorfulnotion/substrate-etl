...
*XCM Interior Keys*:
* `[{"network":"kusama"},{"parachain":2085},{"generalKey":"0x484b4f"}]`


| Chain | # Holders | Free | Reserved | Misc Frozen | Frozen | Price | AssetID |
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [Parallel Heiko](/kusama/2085-parallel-heiko) | 24,039 | 999,999,835.29  | 143.79  | 634,342,548.92   | 633,251,182.61  |  | `{"Token":"HKO"}` |
| [Karura](/kusama/2000-karura) | 33 | 9,883.31  |   |    |   |  | `{"ForeignAsset":"4"}` |
| [Moonriver](/kusama/2023-moonriver) | 24 | 889.71  |   |    |   |  | `{"Token":"76100021443485661246318545281171740067"}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "HKO" and date(ts) = "2023-03-18"
 group by para_id
