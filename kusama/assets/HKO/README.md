...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [Parallel Heiko](/kusama/2085-parallel-heiko) | 24,300 | 999,999,835.29  | 143.79  | 634,971,755.45   | 633,895,793.49  |  | `{"Token":"HKO"}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "HKO" and date(ts) = "2023-02-24"
 group by para_id
