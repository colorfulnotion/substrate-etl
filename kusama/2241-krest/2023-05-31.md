...
|---------|-------------|-----------|----------|--------------|-------------------|--------------------|----------------|-------------|-----------|--------------------|---------------------------|----------------------------|----------|-----------|--------|
| 2023-05-31 | 3,381 | 10,376 | 6,996 | 1 |  |  |  |  | 32,883 | 5,304  |   |   |  |  |  |
| 2023-05-30 | 1,428 | 3,380 | 1,953 |  |  |  |  |  | 6,344 | 1,023  |   |   |  |  |  |
| 2023-05-26 | 1 | 1,427 | 1,427 |  |  |  |  |  | 1,067 | 171  |   |   |  |  |  |
...
SELECT date(origination_ts) as logDT, 
 ...
 where destination_para_id = 2241 and LAST_DAY(date(origination_ts)) = "2023-05-31" 
...
SELECT date(origination_ts) as logDT, 
 ...
 FROM `bigquery-public-data.crypto_kusama.xcmtransfers` 
 where origination_para_id = 2241 and LAST_DAY(date(origination_ts)) = "2023-05-31" 
 group by logDT 
order by logDT
```
