...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [Interlay](/polkadot/2032-interlay) | 371 | 80 $1,427,273.31 | 0.02 $310.33 |    |   | $17,841.21 | `{"Token":"IBTC"}` |
| [Moonbeam](/polkadot/2004-moonbeam) | 101 | 20.8 $371,030.16 |   |    |   | $17,841.21 | `{"Token":"120637696315203257380661607956669368914"}` |
...
| [Parallel](/polkadot/2012-parallel) | 115 | 0.11 $2,035.60 |   |    |   | $17,841.21 | `{"Token":"122"}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "IBTC" and date(ts) = "2023-03-09"
 group by para_id
