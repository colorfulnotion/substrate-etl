...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [Nodle](/polkadot/2026-nodle) | 727,334 | 8,436,235,674.63 $5,675,636.89 | 266,954.38 $116.43 | 5,769,563,771.43  $1,182,686.95 | 5,769,563,771.43 $1,182,686.95 | - | `{"Token":"NODL"}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "NODL" and date(ts) = "2023-03-15"
 group by para_id
