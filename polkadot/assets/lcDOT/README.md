...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [Acala](/polkadot/2000-acala) | 53,993 | 24,116,159.75  |   |    |   |  | `{"LiquidCrowdloan":"13"}` |
| [Parallel](/polkadot/2012-parallel) | 173 | 1,391,790.78  |   |    |   |  | `{"Token":"106"}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "lcDOT" and date(ts) = "2023-03-15"
 group by para_id
