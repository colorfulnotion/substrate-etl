...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [Acala](/polkadot/2000-acala) | 54,029 | 24,116,159.75  |   |    |   |  | `{"LiquidCrowdloan":"13"}` |
| [Parallel](/polkadot/2012-parallel) | 171 | 1,387,611.8  |   |    |   |  | `{"Token":"106"}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "lcDOT" and date(ts) = "2023-03-08"
 group by para_id
