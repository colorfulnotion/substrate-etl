...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [Equilibrium](/polkadot/2011-equilibrium) | 9,354 |   |   |    |   |  | `{"Token":"EQ"}` |
| [Moonbeam](/polkadot/2004-moonbeam) | 12 | 8,843,126.91  |   |    |   |  | `{"Token":"190590555344745888270686124937537713878"}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "EQ" and date(ts) = "2023-03-02"
 group by para_id
