...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [Moonbeam](/polkadot/2004-moonbeam) | 143 | 501,133,667.96  |   |    |   |  | `{"Token":"190590555344745888270686124937537713878"}` |
| [Astar](/polkadot/2006-astar) | 15 | 2,300.35  |   |    |   |  | `{"Token":"18446744073709551628"}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "EQ" and date(ts) = "2023-03-09"
 group by para_id
