...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [Equilibrium](/polkadot/2011-equilibrium) | 9,386 |   |   |    |   |  | `{"Token":"EQ"}` |
| [Moonbeam](/polkadot/2004-moonbeam) | 12 | 454,986,630.55  |   |    |   |  | `{"Token":"190590555344745888270686124937537713878"}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "EQ" and date(ts) = "2023-03-03"
 group by para_id
