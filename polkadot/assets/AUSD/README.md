...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [Acala](/polkadot/2000-acala) | 7,617 | 11,229,566.16 $11,229,566.16 |   |    | 3,734,615.59 $3,734,615.59 | $1.00 | `{"Token":"AUSD"}` |
| [Moonbeam](/polkadot/2004-moonbeam) | 610 | 1,621,479.86 $1,253,732.77 |   |    |   | $0.77 | `{"Token":"110021739665376159354538090254163045594"}` |
| [Astar](/polkadot/2006-astar) | 301 | 106,904.26 $106,904.26 |   |    |   | $1.00 | `{"Token":"18446744073709551617"}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "AUSD" and date(ts) = "2023-03-03"
 group by para_id
