...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [Acala](/polkadot/2000-acala) | 7,592 | 10,446,295.48 $10,446,295.48 |   |    | 3,734,615.59 $3,734,615.59 | $1.00 | `{"Token":"AUSD"}` |
| [Moonbeam](/polkadot/2004-moonbeam) | 617 | 1,481,378.39 $1,076,749.66 |   |    |   | $0.73 | `{"Token":"110021739665376159354538090254163045594"}` |
| [Astar](/polkadot/2006-astar) | 301 | 95,105.5 $95,105.50 |   |    |   | $1.00 | `{"Token":"18446744073709551617"}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "AUSD" and date(ts) = "2023-03-15"
 group by para_id
