...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [Moonbeam](/polkadot/2004-moonbeam) | 114 | 1,048,930 $80,525.86 |   |    |   | $0.08 | `{"Token":"224077081838586484055667086558292981199"}` |
| [Acala](/polkadot/2000-acala) | 102 | 44,292.58 $3,400.32 |   |    |   | $0.08 | `{"ForeignAsset":"2"}` |
| [Bifrost-Polkadot](/polkadot/2030-bifrost-dot) | 12 | 168.75 $12.96 |   |    |   | $0.08 | `{"Token2":"3"}` |
| [Phala](/polkadot/2035-phala) | 11 | 105.33 $8.09 |   |    |   | $0.08 | `{"Token":"6"}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "ASTR" and date(ts) = "2023-03-02"
 group by para_id
