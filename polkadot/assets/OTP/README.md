# OTP on polkadot substrate-etl Summary
...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [Origin Trail](/polkadot/2043-origintrail) | 3,651 | 500,053,154.99  | 166  | 22,330,725.83   |   |  | `{"Token":"OTP"}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "OTP" and date(ts) = "2023-03-02"
 group by para_id
