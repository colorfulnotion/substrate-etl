...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [Clover](/polkadot/2002-clover) | 4,125 | 5,157,903.83 $1,742,097.24 | 90.36 $30.52 | 606,070  $204,701.93 | 605,900 $204,644.51 | $0.34 | `{"Token":"CLV"}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "CLV" and date(ts) = "2023-03-01"
 group by para_id
