...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [Clover](/polkadot/2002-clover) | 2,182 | 5,157,902.96 $1,742,096.95 | 90.36 $30.52 | 606,070  $204,701.93 | 605,900 $204,644.51 | $0.34 | `{"Token":"CLV"}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "CLV" and date(ts) = "2023-03-06"
 group by para_id
