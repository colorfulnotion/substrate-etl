...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [Clover](/polkadot/2002-clover) | 4,126 | 5,157,903.39 $1,742,097.09 | 90.36 $30.52 | 606,070  $204,701.93 | 605,900 $204,644.51 | $0.34 | `{"Token":"CLV"}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "CLV" and date(ts) = "2023-03-04"
 group by para_id
