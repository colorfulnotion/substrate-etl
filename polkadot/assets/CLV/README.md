...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [Clover](/polkadot/2002-clover) | 2,192 | 5,157,900.21 $1,742,096.27 | 90.36 $30.52 | 606,070  $204,701.96 | 605,900 $204,644.54 | $0.34 | `{"Token":"CLV"}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "CLV" and date(ts) = "2023-03-15"
 group by para_id
