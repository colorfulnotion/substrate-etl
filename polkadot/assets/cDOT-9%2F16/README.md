# cDOT-9/16 on polkadot substrate-etl Summary

_Source_: [polkaholic.io](https://polkaholic.io) *Report Date*: 2023-03-04


*XCM Interior Keys*:
* `[{"parachain":2012},{"palletInstance":6},{"generalIndex":200090016}]~polkadot`
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "cDOT-9/16" and date(ts) = "2023-03-04"
 group by para_id
