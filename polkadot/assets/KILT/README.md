...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [KILT Spiritnet](/polkadot/2086-kilt) | 18,167 | 157,669,553.45  | 27,859.8  | 1,000,000,117,314,659   | 75,809,169.56  |  | `{"Token":"KILT"}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "KILT" and date(ts) = "2023-03-10"
 group by para_id
