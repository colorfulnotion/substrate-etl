...
| ----- | --------- | ---- | -------- | ----------- | ------ | ----- | ------- |
| [KILT Spiritnet](/polkadot/2086-kilt) | 18,191 | 157,702,519.42  | 27,882.05  | 1,000,000,117,207,062.8   | 75,801,964.56  |  | `{"Token":"KILT"}` |
...
select para_id, count(distinct address_pubkey) numHolders, 
 ...
 where symbol = "KILT" and date(ts) = "2023-03-13"
 group by para_id
