...
|---------|-------------|-----------|----------|--------------|-------------------|--------------------|----------------|-------------|-----------|--------------------|---------------------------|----------------------------|----------|-----------|--------|
| 2024-07-03 | 3,448,384 | 3,452,476 | 4,093 |  |  |  |  |  | 8,186 |   |   |   |  |  |  |
| 2024-07-02 | 3,442,088 | 3,448,383 | 6,296 |  |  |  |  | 4 | 12,592 |   |   |   |  |  |  |
| 2024-07-01 | 3,435,755 | 3,442,087 | 6,333 |  |  |  |  | 4 | 12,666 |   |   |   |  |  |  |
...
SELECT date(origination_ts) as logDT, 
 ...
 where destination_para_id = 2039 and LAST_DAY(date(origination_ts)) = "2024-07-31" 
...
SELECT date(origination_ts) as logDT, 
 ...
 FROM `bigquery-public-data.crypto_polkadot.xcmtransfers` 
 where origination_para_id = 2039 and LAST_DAY(date(origination_ts)) = "2024-07-31" 
 group by logDT 
order by logDT
```
