...
|---------|-------------|-----------|----------|--------------|-------------------|--------------------|----------------|-------------|-----------|--------------------|---------------------------|----------------------------|----------|-----------|--------|
| 2022-09-30 | 389 | 3,595 | 3,207 |  |  |  |  |  | 10,954 |   |   |   |  |  |  |
| 2022-09-29 | 1 | 388 | 388 | 6 |  |  |  |  | 1,315 | 1  |   |   |  |  |  |
...
SELECT date(origination_ts) as logDT, 
 ...
 where destination_para_id = 2056 and LAST_DAY(date(origination_ts)) = "2022-09-30" 
...
SELECT date(origination_ts) as logDT, 
 ...
 FROM `bigquery-public-data.crypto_polkadot.xcmtransfers` 
 where origination_para_id = 2056 and LAST_DAY(date(origination_ts)) = "2022-09-30" 
 group by logDT 
order by logDT
```
