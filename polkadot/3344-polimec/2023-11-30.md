...
|---------|-------------|-----------|----------|--------------|-------------------|--------------------|----------------|-------------|-----------|--------------------|---------------------------|----------------------------|----------|-----------|--------|
| 2023-11-30 | 2,486 | 9,633 | 7,148 |  |  |  |  | 2 | 14,620 |   |   |   |  |  |  |
| 2023-11-29 | 1 | 2,485 | 2,485 |  |  |  |  | 2 | 5,073 |   |   |   |  |  |  |
...
SELECT date(origination_ts) as logDT, 
 ...
 where destination_para_id = 3344 and LAST_DAY(date(origination_ts)) = "2023-11-30" 
...
SELECT date(origination_ts) as logDT, 
 ...
 FROM `bigquery-public-data.crypto_polkadot.xcmtransfers` 
 where origination_para_id = 3344 and LAST_DAY(date(origination_ts)) = "2023-11-30" 
 group by logDT 
order by logDT
```
